...
function startStarEarning(uid) {
  ...
  function showLoadingBar(duration = 1000) {
    ...
    const loadingInterval = setInterval(() => {
      progress += step + Math.random() * 5; // slight randomness
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  refs = {
    ...
    scrambleInputEl: document.getElementById("scrambleInput"),
    scrambleSubmitBtn: document.getElementById("scrambleSubmitBtn"),
